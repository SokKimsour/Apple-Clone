...
const Header = () => {
  ...
  return (
    <>
      <header className="h-[44px] fixed top-0 z-50 w-full bg-white/80 backdrop-blur-md shadow-sm transition-all duration-300">
        <nav className="mx-auto flex items-center justify-between h-full max-w-[980px] px-4 text-black relative z-[60]">
          ...
          <div className="flex items-center gap-4 min-[830px]:gap-8 z-[60]">
            ...
            >
              <span
                className={`block w-full h-[2px] bg-black transition-all duration-300 ease-in-out ${isMobileMenuOpen ? "rotate-45 translate-y-[3px]" : ""
                  }`}
              />
              <span
                className={`block w-full h-[2px] bg-black transition-all duration-300 ease-in-out ${isMobileMenuOpen ? "-rotate-45 -translate-y-[3px]" : ""
      ...
      {/* Mobile Menu Overlay - Outside the constrained header container */}
      <div
        className={`fixed inset-0 bg-white z-45 pt-[60px] px-8 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${isMobileMenuOpen
